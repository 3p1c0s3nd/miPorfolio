    ...
    return(
        <div className="menu">
           ...
           <div className="flex gap-4 mt-9">
               ...
               <p><img src="./linkenin.png" width={20} height={20} onClick={() => funciones.gotoLocation("https://github.com/3p1c0s3nd")} style={{cursor:"pointer"}}/></p>
               <p><img src="./github.png" width={20} height={20} onClick={() => funciones.gotoLocation("https://www.linkedin.com/in/edwin-fajardo-murillo-88a288287/")} style={{cursor:"pointer"}}/></p>
           </div>
        </div>
    )
}
